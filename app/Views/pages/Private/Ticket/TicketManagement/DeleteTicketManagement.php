<div class="mt-2">
    ...
    <div class="modal" id="delete<?= $key; ?>">
        <div class="modal-box">
            ...
            <p class="py-4 text-blue-500"><?= format_datetime($listTicketManagement['the_day']); ?></p>
            <form action="<?= base_url("/private/ticket/management/delete/" . encrypt_url($listTicketManagement['id'])); ?>" method="post">
                <?= csrf_field(); ?>
